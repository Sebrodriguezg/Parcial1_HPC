...
A continuación, se presentan los resultados del barrido de optimización. Se utiliza el especificador \texttt{[H]} del paquete \texttt{float} para garantizar la cohesión del análisis visual.

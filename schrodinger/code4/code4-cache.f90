...
contains
  ...
  ! Subrutina adaptada para Blocking
  ...
  ! (La subrutina jacobi se mantiene igual ya que las matrices son muy pequeñas: 10x10)
...
program lanczos_fd
  ...
  implicit none
  integer :: log2n, npts, nt, i, j, it, k, m_lanczos, B, ib
  ...
  read(5,*) L
  read(5,*) nt
  read(5,*) B   ! Aplicado en iteraciones espaciales
  ...
  do it = 1, nt
    ...
    do j = 1, m_lanczos
      call apply_h_blocked(v_mat(:,j), h_v, v, dx, npts, B)
